...
{
    {AncestryIndex::ANCESTRY_GENERAL, "Leykin are creatures capable of traversing the leylines that thread the Sealed World's domains together. Their ancestors emerged from veins of sacred earth to inherit the ruins of cities too grand even for all their number. Yet, the day will come that the Leykin outgrow this Bottled World, returning to clay to be sculpted anew once more."},

    {AncestryIndex::ANCESTRY_VERIT, "Individualists who prize personal ideals before laws or traditions. Although the well-travelled quickly adapt to the customs of foreign lands, Verit have gained a reputation for self-righteous impropriety."},
    ...
    {AncestryIndex::ANCESTRY_MAKHI, "Descendents and worshippers of the technological civilization Makhia. They enjoy sleeping in the sun while hirelings toil, and spare no expense or cunning to attract capable candidates to their service."},
    {AncestryIndex::ANCESTRY_BEYU, "Beyu society is regimented to a fault, but still makes ample time for leisure. Their streamlined bodies propel them gracefully through and against the currents of the Thousand Isles."},
...
struct Encyclopedia
{
    ...
    static void LoadConfigurations()
    {
        entries =
        {
            {CATEGORIES_LEYKIN, encyclopediaLeykinLore},

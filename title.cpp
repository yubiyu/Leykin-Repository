...
void Title::Drawing()
{
    ...
    {
        Hax::string_al_draw_text(Font::monogram32, COLKEY_TEXT_VALUE,
...
{
    optionMarkerLeftX = Hax::string_al_get_text_width(Font::monogram32, optionStrings.at(targetedOption))/2 + OPTION_MARKER_SPRITE_WIDTH + OPTION_MARKER_SPRITE_X_SPACING;
    optionMarkerRightX = Hax::string_al_get_text_width(Font::monogram32, optionStrings.at(targetedOption))/2 + OPTION_MARKER_SPRITE_X_SPACING;
}
